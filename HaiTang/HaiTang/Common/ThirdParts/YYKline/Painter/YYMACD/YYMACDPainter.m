...
+ (void)drawToLayer:(CALayer *)layer area:(CGRect)area models:(NSArray <YYKlineModel *> *)models minMax: (YYMinMaxModel *)minMaxModel {
    ...
    [models enumerateObjectsUsingBlock:^(YYKlineModel * _Nonnull m, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        //2020-12-04，downColor与upColor颜色调换了
        l.strokeColor = m.MACD.MACD.floatValue < 0 ? [UIColor downColor].CGColor : [UIColor upColor].CGColor;
        l.fillColor =   m.MACD.MACD.floatValue < 0 ? [UIColor downColor].CGColor : [UIColor upColor].CGColor;
