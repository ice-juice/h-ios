...
//        l.strokeColor = UIColor.timeLineLineColor.CGColor;
        l.strokeColor = [UIColor colorWithRed:0x4c/255.0 green:0x86/255.0 blue:0xCD/255.0 alpha:1].CGColor;
...
//    }
    ...
    // 渐变背景色
    {
        ...
        bgLayer.frame = area;
        bgLayer.colors = @[(id)[UIColor colorWithRed:0x4c/255.0 green:0x86/255.0 blue:0xCD/255.0 alpha:1].CGColor, (id)UIColor.clearColor.CGColor];
