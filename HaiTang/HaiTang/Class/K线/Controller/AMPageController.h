...
extern NSString *const AMControllerDidAddToSuperViewNotification;
extern NSString *const AMControllerDidFullyDisplayedNotification;
@protocol AMPageControllerDataSource <NSObject>
@optional
...
@protocol AMPageControllerDelegate <NSObject>
@optional
 ...
 */
- (void)pageController:(AMPageController *)pageController lazyLoadViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(AMPageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(AMPageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(AMPageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface AMPageController : UIViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, AMPageControllerDataSource, AMPageControllerDelegate>

@property (nonatomic, weak) id<AMPageControllerDelegate> delegate;
@property (nonatomic, weak) id<AMPageControllerDataSource> dataSource;
